                    ...
                    <div class="col-span-2 gap-4">
                        ...
                        <div id="cart-list-container">
                            <?php foreach ($cartItems as $item): ?>
                                ...
                                <div class="cart grid grid-cols-12 border-b-2 border-gray-300 pb-5 mb-3 w-full items-center" data-cart-id="<?= $item['id'] ?>">
                                    ...
                                    <div class="col-span-3 flex flex-col items-end gap-2">
                                        ...
                                        <div class="text-right">
                                            <div class="<?= ($item['sale_price'] != 0) ? 'font-bold text-xl' : 'hidden' ?>"><?= number_format($item['sale_price'], 0, ',', '.') ?>₫</div>
                                            <p class=" <?= ($item['sale_price'] != 0) ? 'line-through text-gray-500 text-sm' : 'font-bold text-xl' ?> "><?= number_format($item['regular_price'], 0, ',', '.') ?> ₫</p>
                                        </div>
                                    </div>
                                </div>
                                <div id="<?= $modalId ?>"
                                    ...
                                    <div class="w-full max-w-md bg-white rounded-xl shadow-lg p-6 relative">
                                        <div class="text-center">
                                            <svg xmlns="http://www.w3.org/2000/svg" class="w-16 h-16 text-red-500 mx-auto" fill="currentColor"
                                                viewBox="0 0 20 20">
                                        ...
                                        <div class="text-center mt-6 space-x-3">
                                            ...
                                            <button
                                                onclick="removeCartItem(<?= $item['id'] ?>, '<?= $modalId ?>')"
