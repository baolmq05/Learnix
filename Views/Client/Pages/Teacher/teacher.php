                        ...
                        <div class="flex flex-col items-end gap-2">
                            ...
                            <div class="flex items-center gap-2">
                                <a href="index.php?page=teacher&action=viewDetail"
                                    class="inline-block text-xs px-3 py-1 bg-gray-100 text-gray-800 rounded-full hover:bg-gray-200">Xem
                                    chi
                                    tiết</a>
                                <button
                                    class="inline-block text-xs px-3 py-1 bg-red-50 text-red-600 rounded-full hover:bg-red-100"
