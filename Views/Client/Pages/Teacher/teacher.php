...
<section class="max-w-screen-2xl mx-auto px-4 py-8">
  <div class="flex items-center justify-between gap-4">
    ...
    <div class="flex items-center gap-2">
      <a href="index.php?page=teacherAddCourse" class="inline-flex items-center gap-2 bg-blue-600 hover:bg-blue-700 text-white px-4 py-2 rounded-md text-sm font-medium shadow-sm">
          ...
          <article class="flex items-center gap-4 border-b pb-4">
            <a href="#" class="flex items-center gap-4 flex-1 min-w-0">
              ...
              <div class="min-w-0">
                ...
                <p class="mt-1 text-sm truncate">
                  <span class="inline-flex items-center text-xs font-medium px-2 py-0.5 rounded-full bg-green-100 text-green-800"><?= $course['students'] ?> học viên</span>
                </p>
            ...
            <div class="flex flex-col items-end gap-2">
              <div class="text-lg font-semibold text-gray-900"><?= $course['price'] ?>₫</div>
                <div class="flex items-center gap-2">
                  <a href="index.php?page=teacher&action=viewDetail" class="inline-block text-xs px-3 py-1 bg-gray-100 text-gray-800 rounded-full hover:bg-gray-200">Xem chi tiết</a>
                  <button class="inline-block text-xs px-3 py-1 bg-red-50 text-red-600 rounded-full hover:bg-red-100" type="button">Xóa</button>
                </div>
            </div>
          </article>
        <?php endforeach; ?>
