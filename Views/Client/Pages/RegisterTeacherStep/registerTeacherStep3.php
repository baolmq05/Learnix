        ...
        <div class="w-full md:w-1/2 bg-white p-8 md:p-16 lg:p-24 flex flex-col justify-center order-2 md:order-1">
            <div class="max-w-md mx-auto w-full">
                ...
                <div class="mb-8 text-gray-600 text-sm">
                    <span class="font-bold text-gray-800">Bước 3</span> trong 3
                    <div class="w-full bg-gray-200 rounded-full h-1 mt-2">
                        <div class="bg-blue-600 h-1 rounded-full w-full"></div>
                    </div>
                </div>

                <h1 class="text-3xl font-bold text-gray-900 mb-6">Mở rộng phạm vi tiếp cận của bạn</h1>

                <p class="text-gray-700 leading-relaxed mb-8">
                    Sau khi xuất bản bạn có thể mở rộng đối tượng học viên...
                </p>

                <h2 class="text-xl font-semibold text-gray-800 mb-6">
                    Bạn có đối tượng nào muốn chia sẻ khóa học của mình không?
                </h2>
